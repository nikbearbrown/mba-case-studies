...
Product introduction questions test whether you can think about a launch as a system. The model will discuss any product launch competently. Competence at general product launches is not the same as judgment about this product launch.

Where the model genuinely helps: surfacing the launch failure modes that have happened in adjacent product categories. The historical pattern library is large and the model is good at retrieving from it.

Where the model does damage: producing the go-to-market plan for the case. The plan depends on the client's distribution, brand, and risk appetite — none of which the model has access to.

The rule: failure-mode library from the model; launch plan from you.

---

## AI Wayback Machine

The ideas in this chapter didn't appear from nowhere. **Geoffrey Moore** wrote *Crossing the Chasm* in 1991 — the framework that explains why most new technology products die between early adopters and the mainstream market. The "chasm" he identified is the central problem in every product-launch case interview.

**Run this:**

```
Who is Geoffrey Moore, and how does "crossing the chasm" connect to the new-product introduction framework we covered in this chapter? Keep it to three paragraphs. End with the single most surprising thing about his career or ideas.
```

→ Search **"Geoffrey Moore"** on Wikipedia.

**Now make the prompt better.** Try one of these:

- Ask it to apply Moore's chasm framework to one specific product launch (electric vehicles in 2010, generative AI in 2023).
- Ask it to compare Moore's framework with Everett Rogers's earlier *Diffusion of Innovations*.
